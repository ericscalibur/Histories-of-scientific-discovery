...
<p>And when Aristotle aimed that method at the sky, he nailed one of the biggest facts there is: <b>the Earth is a sphere</b>. His proofs still work. Travel south, and new stars climb above the horizon — that only happens on a curved surface. Better: during a lunar eclipse, the Earth's shadow creeps across the Moon, and that shadow is <b>always round, every single time</b>. Educated people have known the Earth is round ever since — Columbus's sailors knew it too, whatever the internet tells you.</p>
...
<p>The spell held until people finally re-ran his checks. Galileo used a thought experiment worthy of Plato — imagine a heavy stone chained to a light one: does the light one drag the pair slower, or make a heavier, faster whole? Aristotle's rule fights itself! — then rolled balls down ramps to time the truth: everything falls alike. Tycho's new star and great comet shattered the changeless heavens. Kepler broke the perfect circles. Every hero of this series, you'll notice, earned the title the same way: <b>by checking</b>.</p>
