...
CONSTELLATIONS = [
    ...
    dict(
        ...
        stars=[("Betelgeuse", 5.919, 7.407), ("Meissa", 5.585, 9.934),
               ...
               ("Pi1 Ori", 4.915, 10.151), ("Pi2 Ori", 4.844, 8.900),
               ("Tabit (Pi3)", 4.831, 6.961), ("Pi4 Ori", 4.853, 5.605),
               ("Pi5 Ori", 4.904, 2.441), ("Pi6 Ori", 4.976, 1.714)],
        paths=["ABC", "CDEFA", "DGHF", "IJKLMN", "CK"],
        note="I–N form the bow; C → K is the arm.",
    ),
    dict(
