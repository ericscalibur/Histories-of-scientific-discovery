...
<div class="bigidea">🌟 <b>Big Idea #1:</b> The greatest year in the history of science happened to a student locked out of school, bored, at his mum's farm. Empty time isn't empty — it's where long thoughts finally fit.</div>""",
        ...
        dict(
            ...
            title="The Apple",
            html="""
<p>Picture the scene. A summer day in 1666, in the quiet of the plague year. Behind the farmhouse at Woolsthorpe there is a small orchard, and under one of its trees sits Isaac Newton — twenty-three years old, stuck at home, nowhere to go and nothing to do but think. And while he sits there, it happens:</p>
<p style="text-align:center; font-size:1.12rem;"><b>An apple lets go of its branch and drops to the grass.</b></p>
<p>That's the whole event. No lightning bolt. No voice from the sky. An apple fell, the way apples had fallen on every farm since the beginning of farms — and out of that one ordinary <i>thump</i> came the biggest idea in the history of science. This story is famous all over the world, and here's the good news: <b>it really happened.</b> Newton told it himself, as an old man, to his friend William Stukeley over tea <i>under apple trees</i> — the idea of gravity came to him "occasioned by the fall of an apple, as he sat in a contemplative mood." Only one part of the famous version is fake: the apple bonking him on the head. That was invented later, to make a better cartoon. (You now know to check.)</p>
...
<p>Newton wrote the whole thing as one equation — the <b>universal law of gravitation</b>:</p>
<p style="text-align:center; font-size:1.18rem;">F = G × (m₁ × m₂) ÷ r²</p>
<p>Read it piece by piece. The pull (F) between <i>any</i> two objects equals their two masses multiplied together (m₁ × m₂), divided by the square of the distance between their centers (r²) — there's the orchard rule — all scaled by <b>G</b>, the gravitational constant: one fixed number for the entire universe. Bigger masses, stronger pull. Double the distance, four times weaker. And notice what the equation does <b>not</b> mention: whether the objects are apples, moons, comets, planets, or you. Any two masses, anywhere, always.</p>
<div class="funfact">⚖️ Newton never knew the actual number G. Measuring it meant detecting the tiny gravitational tug between two metal balls in a laboratory — Henry Cavendish pulled it off in 1798, 71 years after Newton died. And once you have G, the equation runs backwards: Cavendish used it to <b>weigh the Earth</b>.</div>
